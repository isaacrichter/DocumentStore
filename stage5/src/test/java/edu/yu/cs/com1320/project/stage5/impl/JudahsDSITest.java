...
public class JudahsDSITest {
    ...
    public void init() throws Exception {
        ...
        this.pdfData4 = txtToPdf(this.pdfTxt4);
    ...
    public void testPutPdfDocumentNoPreviousDocAtURI(){
        DocumentStore store = new DocumentStoreImpl(new File("\\C:\\Users\\yitzy\\Documents\\ForTestingStage5"));

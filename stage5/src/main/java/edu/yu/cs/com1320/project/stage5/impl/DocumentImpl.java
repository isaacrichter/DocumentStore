...
public class DocumentImpl implements Document {
    ...
    public DocumentImpl(URI uri, String txt, int txtHash){
        ...
        // this.wordMap puts into trie

    }

    public DocumentImpl(URI uri, String txt, int txtHash, Map<String, Integer> wordMap){
        this.uri = uri;
        this.txt = txt;
        this.txtHash = (txtHash & 0x7fffffff);
        this.pdfBytes = txtToPdf(txt);
    ...
    protected void setTrie(TrieImpl<DocumentImpl> trie){
    ...
    public int compareTo(Object o) {
        ...
        //if this doc was used less recently return 1
        if(this.getLastUseTime() > (((DocumentImpl)o).getLastUseTime())){
            return 1;
            //if this doc was used more recently return -1
        } else if (((DocumentImpl)o).getLastUseTime() > this.getLastUseTime()){
            return -1;
        }else{return 0;}
    }
}
